...
| `--model`                 | `str`  | `'openai_clip'`       | Embeddings model to use for embedding computation. The list of possible models is available in the [embeddings models enum](src/enum.py) under `EmbeddingsModel`         |
